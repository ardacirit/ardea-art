...
import { artworks } from '../data/collections'
    ...
    <>
      ...
      <section className="bg-ardea-bej py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-ardea-brown text-sm tracking-widest uppercase">
            Ardea Art
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="divider" />
            <p className="text-ardea-text-soft leading-relaxed mb-4">
              {tr(t.about.p1, lang)}
            </p>
            <p className="text-ardea-text-soft leading-relaxed mb-8">
              {tr(t.about.p2, lang)}
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {latestPosts.map(post => (
              <BlogTeaser key={post.id} post={post} lang={lang} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="bg-ardea-cobalt py-16 px-6 text-center">
        ...
        <h2 className="font-serif text-3xl text-white mb-6">@ardea.art</h2>
        <a
          href="https://instagram.com/ardea.art"
          target="_blank"
          ...
          className="inline-flex items-center gap-2 px-6 py-3 border border-white/60 text-white text-sm font-medium tracking-wide
                     transition-all duration-300 hover:bg-white hover:text-ardea-cobalt"
        >
          Instagram
  ...
  return (
    <Link to={`/blog/${post.slug}`} className="group flex gap-6 items-start">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-ardea-text-muted text-xs">
