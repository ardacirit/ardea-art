...
export default function WhatsAppButton({ lang = 'tr' }) {
  ...
  return (
    <a
      ...
      className="whatsapp-float flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-green-500/30 hover:bg-[#20bc5a] transition-colors duration-200"
